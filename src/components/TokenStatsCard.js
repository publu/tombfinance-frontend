  ...
  return (
    <Card innerClass="flex flex-col text-center items-center lg:w-64 py-4 px-4">
      ...
      <div className="flex items-center">
        ...
        <span className="text-white text-4xl font-Amarante mt-1">{numberWithCommas(ftmPrice)}</span>
      </div>
      <div className="mt-1">
        <span className="text-tomb-purple text-md font-Amarante mr-1">USD</span>
        <span className="text-white text-md font-Amarante">${numberWithCommas(usdPrice)}</span>
      </div>
      <span className="text-tomb-purple text-xs font-semibold mt-3">Market Cap:</span>
      <div className="">
        <span className="text-white text-lg font-semibold tracking-wider">${numberWithCommas(mktCap)}</span>
      </div>
      <span className="text-tomb-purple text-xs font-semibold mt-3">Circulating Supply:</span>
      <div className="">
        <span className="text-white text-lg font-semibold tracking-wider">{numberWithCommas(circSupply)}</span>
      </div>
      <span className="text-tomb-purple text-xs font-semibold mt-3">Total Supply:</span>
      <div className="">
        <span className="text-white text-lg font-semibold tracking-wider">{numberWithCommas(totalSupply)}</span>
      </div>
